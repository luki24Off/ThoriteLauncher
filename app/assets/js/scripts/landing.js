        ...
        if(m.context === 'validateJava'){
            if(m.result == null){
                ...
                setOverlayContent(
                    ...
                    'In order to join Thorite, you need a 64-bit installation of Java 8. Would you like us to install a copy?',
                    'Install Java',
                    'Install Manually'
                )
                setOverlayHandler(() => {
        ...
        if(m.context === 'validate'){
            ...
            if(login && allGood) {
                ...
                const onLoadComplete = () => {
                    toggleLaunchArea(false)
                    if(hasRPC){
                        DiscordWrapper.updateDetails('Lancement du jeux...')
                    }
                ...
                const gameStateChange = function(data){
                    ...
                    if(SERVER_JOINED_REGEX.test(data)){
                        DiscordWrapper.updateDetails('Joue à Thorite')
